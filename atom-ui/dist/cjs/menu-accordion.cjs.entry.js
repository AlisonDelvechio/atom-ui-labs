...
const MenuAccordion = class {
    ...
    render() {
        return (index.h("div", { key: '092ec8fc5e80eb02502643f39986fa0d459cda1b', class: `accordion ${this.device} ${this.isExpanded ? 'expanded' : ''}` }, index.h("button", { key: '4d88679f8debb28380a7b833da34025b034bb033', class: "accordion-header", onClick: () => this.toggleAccordion(), "aria-expanded": this.isExpanded }, index.h("span", { key: '1852cd61aa0a8f31bf08b1233d4d632e6b69e583', class: "title" }, this.heading), this.renderExpandIcon()), index.h("div", { key: '9ae592e74550c064910727d543dddc1e8177d39b', class: `accordion-content ${this.isExpanded ? 'expanded' : 'collapsed'}` }, index.h("div", { key: '6e99963ec7e1c43c9e84846dcf9776d0649a854a', class: "accordion-slot-wrapper" }, index.h("slot", { key: '227a572f83b93302a2bf95d538288d339d551d23' })))));
    }
};
