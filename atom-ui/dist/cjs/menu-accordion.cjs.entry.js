...
const MenuAccordion = class {
    ...
    getChevronRightIcon() {
        return (index.h("svg", { class: "icon", width: "24", height: "24", viewBox: "0 0 24 24" }, index.h("path", { d: "M10 17l5-5-5-5v10z" })));
    }
    toggleAccordion() {
        this.isExpanded = !this.isExpanded;
    }
    render() {
        return (index.h("div", { key: 'c8b4d6ca5943b5b14b1de5c8480aee1f9507f141', class: `accordion ${this.device} ${this.isExpanded ? 'expanded' : ''}` }, index.h("button", { key: '8c8f86a762a7c2d6b13c379cca4846bf335c06c3', class: "accordion-header", onClick: () => this.toggleAccordion(), "aria-expanded": this.isExpanded }, index.h("span", { key: 'e3423d174c71a467b3a35361113ddf643833c0de', class: "title" }, this.heading), this.renderExpandIcon()), this.isExpanded && (index.h("div", { key: '48232b3d74bc1a7feb9990041d5f0d4744408e3a', class: "accordion-content" }, this.items.map((item) => (index.h("div", { class: "accordion-item" }, index.h("span", null, item), this.getChevronRightIcon())))))));
    }
};
